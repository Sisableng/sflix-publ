...
import { useInfiniteByCountry } from "./hooks/useInfiniteByCountry";
...
export default function ListByCountry() {
  const params = useParams();
  const query = String(params.countryCode);
  const { data, error, isLoading, isLoadingMore, isReachingEnd, loadMore } =
    useInfiniteByCountry({ query });
